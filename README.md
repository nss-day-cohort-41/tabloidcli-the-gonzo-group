...
## Installation
git clone
then open up tabloidcli-the-gonzo-group
Then through the the main menu
...
## Contributing
Faith Magras worked on journal
Nicholas Glover worked on blog
Zach McWhirter worked on journal and post
Drew Harper worked on post
